...
sign-in; do **NOT** scaffold demo/mock/hardcoded users. Live preview federates
through a popup against a baked preview client, a deployed app through its own
per-app client + `DATABASE_URL` (`references/prewired-and-env.md`).
